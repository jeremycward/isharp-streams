...
public class KeyedPoloCaptureWindowTransformerSupplier implements TransformerSupplier<Windowed<String>, PoloCaptureWindow, KeyValue<String, KeyedPoloCaptureWindow>> {
    ...
    private final Transformer<Windowed<String>, PoloCaptureWindow,KeyValue<String, KeyedPoloCaptureWindow>> transformer = new Transformer<Windowed<String>, PoloCaptureWindow,KeyValue<String, KeyedPoloCaptureWindow>>(){
        @Override
